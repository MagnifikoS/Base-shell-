-- Fix D-02: PostgREST sends text[] but RPC expects uuid[]
-- Change parameter type to text[] and cast internally
...
CREATE OR REPLACE FUNCTION public.resolve_commande_user_names(p_commande_ids text[])
