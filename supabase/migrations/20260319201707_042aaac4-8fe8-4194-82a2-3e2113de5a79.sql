...
-- ═══════════════════════════════════════════════════════════════════
-- Phase 3: Fix fn_resolve_litige
-- ═══════════════════════════════════════════════════════════════════
-- Changes:
-- 1. Use fn_convert_b2b_quantity for each litige line
-- 2. Remove override_flag=true (respect Stock Zero V1)
-- 3. Write supplier unit/qty to stock_document_lines
-- 4. Skip lines where conversion fails (no silent corruption)
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  LOOP
    ...
    -- ══════════════════════════════════════════════════════════════════════
    -- Post document WITHOUT override — respects Stock Zero V1
    -- ══════════════════════════════════════════════════════════════════════
