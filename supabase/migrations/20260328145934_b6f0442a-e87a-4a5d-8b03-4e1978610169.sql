...
-- Fix Step 5 FINAL: Use SSOT formula (snapshot + events with active snapshot_version)
-- This aligns fn_ship_commande with fn_post_stock_document and fn_get_b2b_supplier_stock
-- The previous SUM(all events) approach was incorrect.
...
BEGIN
  ...
  -- Uses SSOT stock formula: snapshot_qty + events_since_snapshot
  -- Same formula as fn_post_stock_document and fn_get_b2b_supplier_stock
  -- ═══════════════════════════════════════════════════════════════
  ...
  -- ══════════════════════════════════════════════════════════
  -- SSOT Stock: snapshot_qty + SUM(events with active snapshot_version)
  -- Matches fn_post_stock_document and fn_get_b2b_supplier_stock exactly
  -- ══════════════════════════════════════════════════════════
  member_stock AS (
    SELECT gmf.*,
      GREATEST(
    ...
    -- Get the active snapshot for the member's zone
