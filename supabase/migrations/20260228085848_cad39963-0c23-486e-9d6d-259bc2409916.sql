-- ═══════════════════════════════════════════════════════════════════════════
-- RESTAURATION fn_post_stock_document
-- Signature : 27/02 (p_posted_by pos 3, p_idempotency_key pos 4)
-- Corps : 16/02 fonctionnel + FOR UPDATE ajouté
-- Date : 2026-02-28
-- Ref audit : docs/AUDIT_CALLERS_FN_POST_STOCK_DOCUMENT.md
-- ═══════════════════════════════════════════════════════════════════════════
