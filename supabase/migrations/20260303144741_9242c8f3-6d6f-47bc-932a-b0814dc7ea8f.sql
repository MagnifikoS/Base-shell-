...
-- B2B import: call fn_initialize_product_stock after product creation
-- to auto-bootstrap snapshot + inventory_line (no duplication)
...
BEGIN
  ...
  -- 6. SSOT: Initialize stock via centralized RPC (auto-bootstraps snapshot if needed)
