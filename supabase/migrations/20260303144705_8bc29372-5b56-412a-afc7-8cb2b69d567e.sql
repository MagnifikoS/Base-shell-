...
-- ═══════════════════════════════════════════════════════════════════
-- BOOTSTRAP SNAPSHOT: fn_initialize_product_stock now auto-creates
-- a snapshot + session if none exists for the zone.
-- This eliminates "Aucun inventaire terminé pour cette zone" forever.
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  IF v_snapshot IS NULL THEN
    ...
    -- Create a bootstrap inventory session (already completed, 0 products)
    ...
    -- Create the zone snapshot pointing to this bootstrap session
