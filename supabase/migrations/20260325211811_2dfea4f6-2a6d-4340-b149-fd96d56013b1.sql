...
-- ═══════════════════════════════════════════════════════════════════
-- fn_convert_b2b_quantity V4.1: Add RAISE LOG for fallback tracking
-- ═══════════════════════════════════════════════════════════════════
-- Adds logging when UUID mapping lookup misses and fallback kicks in.
-- Uses RAISE LOG (not WARNING/NOTICE) — visible only in Postgres logs,
