...
-- ═══════════════════════════════════════════════════════════════
-- STEP 1: Add INITIAL_STOCK to enums
-- ═══════════════════════════════════════════════════════════════
ALTER TYPE stock_document_type ADD VALUE IF NOT EXISTS 'INITIAL_STOCK';
ALTER TYPE stock_event_type ADD VALUE IF NOT EXISTS 'INITIAL_STOCK';

-- ═══════════════════════════════════════════════════════════════
-- STEP 2: Rewrite fn_initialize_product_stock
-- Accepts target_quantity, creates inventory_line + INITIAL_STOCK doc + event
-- ═══════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- ═══ 6. Create INITIAL_STOCK document (directly POSTED) ═══
  IF p_target_quantity > 0 THEN
    ...
    -- ═══ 7. Insert stock_event with delta = target_quantity ═══
