...
-- 1) Add UNIQUE constraint on litiges(commande_id) to prevent multiple litiges per commande
ALTER TABLE litiges ADD CONSTRAINT litiges_commande_id_unique UNIQUE (commande_id);

-- 2) Rewrite fn_receive_commande to handle litige creation ATOMICALLY
