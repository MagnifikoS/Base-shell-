-- ═══════════════════════════════════════════════════════════════════════════
-- FIX P0: fn_post_b2b_reception — 'completed' → 'FINAL'
-- 
-- Root cause: bl_app_documents has CHECK(status IN ('DRAFT','FINAL'))
-- but the RPC was inserting 'completed' → violates constraint.
-- This is the ONLY change vs previous version.
-- ═══════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- FIX: Use 'FINAL' (valid CHECK value), NOT 'completed'
