...
-- FAIL-SAFE: Wrap fn_trg_detect_post_close_conflict in BEGIN/EXCEPTION
-- so internal errors NEVER block a POST/VOID operation.
-- Conflict detection is advisory, not transactional.
...
BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN
    ...
    RAISE WARNING 'fn_trg_detect_post_close_conflict fail-safe caught: % %', SQLERRM, SQLSTATE;
  END;
