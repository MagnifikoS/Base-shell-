-- ═══════════════════════════════════════════════════════════════════════════
-- STOCK ZÉRO SIMPLE V2 — Phase 2: Simplification fn_resolve_litige
--
-- Supprime la logique spéciale surplus (v_zone_has_surplus / override conditionnel).
-- Le moteur central (fn_post_stock_document Phase 1) gère désormais le clamp.
-- ═══════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  LOOP
    ...
    -- ══════════════════════════════════════════════════════════════════════
    -- Post document — Stock Zéro Simple V2:
    -- Le moteur central gère le clamp universel.
    -- Plus de logique spéciale surplus/override.
    -- ══════════════════════════════════════════════════════════════════════
